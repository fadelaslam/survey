...
<body>
    ...
    <script>
		var ctx = document.getElementById("petikemasChart").getContext('2d');
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: '# of Votes',
					data: [12, 19, 3, 23, 2, 3, 12, 19, 3, 23, 2, 3, 12, 70, 3, 23, 2, 3, 12, 19, 3, 23, 2, 3],
					backgroundColor: [
					'rgba(255, 99, 132, 0.2)',
					'rgba(54, 162, 235, 0.2)',
					'rgba(255, 206, 86, 0.2)',
        ...
        var ctx = document.getElementById("nonPetikemasChart").getContext('2d');
		var myChart = new Chart(ctx, {
			type: 'bar',
			data: {
