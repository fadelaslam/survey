...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <img src="{{ asset('users/images/pelindo4-logo.png') }}" style="width:70%;" id="icon" alt="User Icon" />
            <br>
            <br>
            <p>Suurvey Pelanggan Non-Petikemas <br> PT. Pelabuhan Indonesia IV (Persero) </p>
            </div>
